...
type
  ...
  ['{06395354-FEDE-FDC9-368D-51C37A49D0E0}']
    ...
    function  consultaCEP(const cep: string;const usuario: string; const senha: string): enderecoERP; stdcall;
...
const
  defWSDL = 'https://apphom.correios.com.br/SigepMasterJPA/AtendeClienteService/AtendeCliente?wsdl';
...
initialization
  ...
  InvRegistry.RegisterParamInfo(TypeInfo(AtendeCliente), 'consultaCEP', 'cep', '',
                                '', IS_UNQL);
  InvRegistry.RegisterParamInfo(TypeInfo(AtendeCliente), 'consultaCEP', 'usuario', '',
                                '', IS_UNQL);
  InvRegistry.RegisterParamInfo(TypeInfo(AtendeCliente), 'consultaCEP', 'senha', '',
                                '', IS_UNQL);
